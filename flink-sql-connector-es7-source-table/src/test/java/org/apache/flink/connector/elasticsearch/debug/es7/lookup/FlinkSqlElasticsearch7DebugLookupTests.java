package org.apache.flink.connector.elasticsearch.debug.es7.lookup;
...
@SetEnvironmentVariable(key = "ES_SOURCE_HOST", value = "http://127.0.0.1:10700")
...
@SetEnvironmentVariable(key = "ES_DIM_HOST", value = "http://127.0.0.1:10700")
...
public class FlinkSqlElasticsearch7DebugLookupTests extends ElasticsearchTestBase {
    ...
    private static final String RESOURCE_PATH = "elasticsearch/es7/lookup/";
